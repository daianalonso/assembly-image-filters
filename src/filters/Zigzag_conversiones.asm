	...
	.aplicarFiltro:
		...
		.procesarSiguienteFila:
			...
			.procesarSiguienteColumna:
				...
				cvtdq2ps xmm1, xmm1 	; Todo en floats  
				movdqu xmm8, [cinco]
				divps xmm1, xmm8 		; xmm1 = |suma(b(p4,p3,p2,p1,p0))/5|suma(b(p4,p3,p2,p1,p0))/5|suma(b(p4,p3,p2,p1,p0))/5|suma(b(p4,p3,p2,p1,p0))/5| 
				cvtps2dq xmm1, xmm1
				...
				packusdw xmm3, xmm12		; xmm3 = |0x0|res1(R)|res1(G)|res1(B)|0x0|res0(R)|res0(G)|res0(B)|
